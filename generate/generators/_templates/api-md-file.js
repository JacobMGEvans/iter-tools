...
const methodSignatureTemplate = require('./method-signature');
...
const methodTemplate = (doc, aliasMap) => {
  ...
  const signature = doc.signature ? `${methodSignatureTemplate(doc.signature)}\n\n` : '';
  return `### ${name}\n${signature}${aliases}${readme || see || 'Undocumented.'}\n`;
};
          ...
          return [false, true]
            .map(ASYNC => {
              ...
              return {
                ...
                signature: ASYNC ? doc.asyncSignature : doc.signature,
                isAsyncClone: ASYNC,
              };
            })
            .concat(
                ...
                ? [
                    {
                      ...
                      signature: doc.parallelSignature,
                      isAsyncClone: false,
                    },
                  ]
                : [],
